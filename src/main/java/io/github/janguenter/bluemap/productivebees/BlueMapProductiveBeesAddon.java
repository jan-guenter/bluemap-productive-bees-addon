...
package io.github.janguenter.bluemap.productivebees;

import io.github.janguenter.bluemap.productivebees.adapter.bluemap522.AdapterCompatibility;

import java.lang.reflect.InvocationTargetException;
import java.lang.reflect.Method;

/** BlueMap add-on entrypoint installed before resource-pack construction. */
public final class BlueMapProductiveBeesAddon implements Runnable {
    ...
    public void run() {
        try {
            ...
            Class<?> adapter = Class.forName(
                    "io.github.janguenter.bluemap.productivebees.adapter.bluemap522.BlueMap522Adapter",
                    true,
                    BlueMapProductiveBeesAddon.class.getClassLoader()
            );
    ...
    private static void inactive(String reason, Throwable cause) {
        ...
        System.err.println("BlueMap Productive Bees add-on is inactive: "
                + reason + detail + '.');
    }
}
