# Agent guide for the Productive Bees BlueMap add-on
...
- Exact profile `productivebees-1.21.1-13.13.5`
...
The scaffold's unresolved-implementation marker is permitted only during the
fast prototype phase. The release gate rejects it.
